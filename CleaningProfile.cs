    ...
    public class CleaningProfile
    {
        ...
        public static CleaningProfile CreateQuickProfile()
        {
            return new CleaningProfile
            {
                ...
                Description = "Nettoyage rapide des fichiers temporaires et caches navigateurs",
        ...
        public static CleaningProfile CreateCompleteProfile()
        {
            return new CleaningProfile
            {
                ...
                Description = "Nettoyage complet incluant système et options avancées",
                EmptyRecycleBin = true,
        ...
        public static CleaningProfile CreateDeveloperProfile()
        {
            return new CleaningProfile
            {
                Name = "Nettoyage Développeur",
                Description = "Nettoyage spécialisé pour développeurs (Node, Python, VS, Git, Docker)",
                EmptyRecycleBin = true,
                CleanBrowsers = true,
        ...
        public static CleaningProfile CreatePrivacyProfile()
        {
            return new CleaningProfile
            {
                Name = "Protection Vie Privée",
                Description = "Efface l'historique et les traces d'activité Windows",
                CleanBrowsers = true,
